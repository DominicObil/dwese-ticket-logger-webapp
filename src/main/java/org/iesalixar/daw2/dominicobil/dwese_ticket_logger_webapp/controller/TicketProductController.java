...
import org.iesalixar.daw2.dominicobil.dwese_ticket_logger_webapp.entities.*;
import org.iesalixar.daw2.dominicobil.dwese_ticket_logger_webapp.repositories.*;
...
public class TicketProductController {
    ...
    public String searchProduct(@RequestParam("productSearch") String productSearch, @RequestParam("ticketId") Long ticketId, Model model) {
        ...
        List<Products> searchResults = productRepository.findByNameContainingIgnoreCase(productSearch);
